import random
"""
Bogosort is a sorting algorithm that shuffles the list over and over again until the list is sorted.
The average time complexity for bogosrto is O(n*n!) while the worst case is O(∞)
"""
